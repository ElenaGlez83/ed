...
/**
 * Interfaz que define todos las posibles acciones que se pueden realizar en un
 * tablero de ajedrez, desde consultar las piezas a moverlas o eliminarlas, así
 * como guardar y cargar la partida.
 *
...
public interface ChessBoard {
    ...
    /**
     * Esta función devuelve un array con todas las piezas que hay en el
     * tablero. No contiene nulls.
     *
    ...
    /**
     * Igual que la función getPieces, pero solo con las fichas de un color
     * determinado.
     *
    ...
    /**
     * Dada una pieza, esta función devuelve la posicion que ocupa esa pieza en
     * el tablero.
     *
